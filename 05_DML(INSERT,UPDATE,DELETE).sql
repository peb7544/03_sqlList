...
SELECT * FROM EMPLOYEE2 WHERE EMP_NAME = '방명수';
...
INSERT INTO EMP_M02
VALUES(999, '곽두원', '561016-1234567', 'kwack_dw@kh.or.kr','01011112222','D9', 'D4', 'S1', 9000000, 0.5, NULL, SYSDATE, NULL, DEFAULT);
...
-- 롤백확인
SELECT	* FROM EMPLOYEE2 WHERE EMP_NAME = '장채현'; --> 조회 결과 있음
