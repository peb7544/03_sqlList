...
-- 단, 최신글이 제일 위에 존재
-- 몇 초/분/시간 전 또는 YYYY-MM-DD 형식을 작성일 조회
-- + 댓글 개수
-- + 좋아요 개수
...
-- 현재 시간 - 한시간 전
SELECT 
	(SYSDATE - TO_DATE('2024-04-21 10:45:30', 'YYYY-MM-DD HH24:MI:SS')) * 60 * 60 * 24
FROM DUAL;
...
UPDATE BOARD_IMG SET BOARD_NO = 1988;
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_CODE, READ_COUNT,
	...
	(SELECT COUNT(*)
	 FROM "BOARD_LIKE"
	 WHERE BOARD_NO = 1988) LIKE_COUNT,
...
update  MEMBER SET PROFILE_IMG = '/images/profile/20240417153503_00001.webp' WHERE MEMBER_NO ='1';
...
-- 댓글 개인 Board.NO() BOARD_NO=2003
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 1', DEFAULT, DEFAULT, 2003,
				1,NULL);



INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 2', DEFAULT, DEFAULT, 2003,
				2,NULL);
			
				
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 3', DEFAULT, DEFAULT, 2003,
				3,NULL);

			
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 1의 자식1', DEFAULT, DEFAULT, 2003,
				1,2013);
			
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 1의 자식2', DEFAULT, DEFAULT, 2003,
				1,2013);
			
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 3의 자식1', DEFAULT, DEFAULT, 2003,
				1,2016);
			
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모댓글 3의 자식1의 자식', DEFAULT, DEFAULT, 2003,
				1,2022);
...
-- 부모의 COMMENT_NO 와 같은 PAREMENT_COMMENT_NO 가진 행을 자식으로 지정
CONNECT BY PRIOR COMMENT_NO = PARENT_COMMENT_NO
...
-- 둘이 타입이 안맞아서 UNION 안되는걸([72000]: ORA-12704: 문자 집합이 일치하지 않습니다)
-- 캐스팅으로 해결!
...
UNION
SELECT 
	SUBSTR(PROFILE_IMG, INSTR(PROFILE_IMG, '/', -1) + 1) "rename"
FROM "MEMBER"
