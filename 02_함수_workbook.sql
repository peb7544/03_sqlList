...
-- 9. 춘 대학에는 어떤 계열(CATEGORY)들이 있는지 조회해보세요
...
-- 10. 02학번 전주 거주자들의 모임을 만드렬고 한다. 휴학한 사람들은 제외한 재학중인
...
FROM TB_STUDENT
WHERE ABSENCE_YN = 'N'
AND EXTRACT(YEAR FROM ENTRANCE_DATE) = 2002 --AND TO_CHAR( ENTRANCE_DATE, 'YY') = '02'
